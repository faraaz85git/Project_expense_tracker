...
class Test_user_menu:
    ...
    def test_choice_2_has_data(self, monkeypatch):
        ...
        self.mock_user.role = "user"
        self.mock_user.show_all_expense2 = MagicMock(
            return_value=[("1", "housing", "2024-08-01", "209", "")]
        )
    ...
    def test_choice_5(self, monkeypatch):
        ...
        # assert
        self.mock_user.show_expense_by_category2.assert_called_once_with(
            {"transport": "y", "food": "y"}
        )
        self.mock_main_menu.assert_called_once()
    ...
    def test_choice_7(self, monkeypatch):
        ...
        self.mock_user.show_budget_status_by_category2 = MagicMock(
            return_value=[{}, {}]
        )
        ...
        monkeypatch.setattr("builtins.input", mock_input)
        monkeypatch.setattr(
            "ui_layer.user_menu.display_budget_status", mock_display_budget_status
        )
        user_menu(self.mock_user, self.mock_main_menu)
        # assert
