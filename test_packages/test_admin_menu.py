...
class Test_admin_menu:
    ...
    def test_admin_menu_choice_2_1(self,monkeypatch):
        mock_input=MagicMock(side_effect=['2','1','4','3'])
        mock_myfun=MagicMock()
        ...
        self.mock_user.show_all_users_expenses1.assert_not_called()
        self.mock_user.delete_user1.assert_not_called()

    def test_admin_menu_choice_2_2(self,monkeypatch):
        mock_input=MagicMock(side_effect=['2','2','4','3'])
        mock_myfun=MagicMock()
        self.mock_user.username='User1'
        #act
        monkeypatch.setattr('builtins.input',mock_input)
    ...
    def test_admin_menu_choice_2_3(self,monkeypatch):
        ...
        self.mock_main_menu.assert_called_once()
        self.mock_user.show_all_users_expenses1.assert_not_called()
        self.mock_user.delete_user1.assert_called_once()

    def test_admin_menu_choice_2_4(self,monkeypatch):
        mock_input=MagicMock(side_effect=['2','4','3'])
        mock_myfun=MagicMock()
        self.mock_user.username='User1'
        #act
        monkeypatch.setattr('builtins.input',mock_input)
    ...
    def test_admin_menu_choice_2_5(self,monkeypatch):
        mock_input=MagicMock(side_effect=['2','5','4','3'])
        mock_myfun=MagicMock()
        self.mock_user.username='User1'
        #act
        monkeypatch.setattr('builtins.input',mock_input)
